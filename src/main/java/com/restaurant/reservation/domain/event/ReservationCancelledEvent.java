...
/**
 * Evento de domínio disparado quando uma reserva é cancelada.
 * Pode ser usado para liberar a mesa, notificar o cliente, etc.
 * 
...
public class ReservationCancelledEvent implements DomainEvent {
    ...
    public ReservationCancelledEvent(ReservationId reservationId, TableId tableId, 
    ...
    public String toString() {
        return String.format("ReservationCancelledEvent{reservationId=%s, tableId=%s, " +
